...
```{r}
data_dir <- "../data"
ine_data_dir <- paste0(data_dir, "/INE/datos_2020")
```
...
```{r}
save(hogar, file = paste0(data_dir, "/hogar.Rdata"), compress = "xz")
save(miembros, file = paste0(data_dir, "/miembros.Rdata"), compress = "xz")
save(gastos, file = paste0(data_dir, "/gastos.Rdata"), compress = "xz")
```
